...
public class StaleElementUtils {
    public static WebElement refreshElement(WebDriver driver,WebElement elem){
       System.out.println("Is Element Stale ??"+ isElementStale(elem));
    ...
    private static WebElement getWebElement(Object lastObject, String key, String value){
        ...
        try {
            ...
            System.out.println("67 - "+ by.toString());
